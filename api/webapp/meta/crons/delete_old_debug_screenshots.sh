#!/bin/sh
#
# Deletes old debug screenshots from the system
# Author: Mark Hobson
# Date: 11/16/2010
# Description: 	Deletes old debug screenshots from the system
#
...
COMMAND="$PHP_BIN $DOCROOT_DIR/daemon.php -m Cron -a DeleteOldDebugScreenshots"
