#!/bin/sh
#
# Starts an export based on it's export id
# Author: Mark Hobson
# Date: 11/16/2010
# Description: 	Starts an export based on it's export id
#
...
COMMAND="$PHP_BIN $DOCROOT_DIR/daemon.php -m Cron -a ExportQueue --id=$1"
