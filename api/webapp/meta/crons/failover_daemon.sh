#!/bin/sh
#
# Starts the failover daemon that manages failover splits
# Author: Mark Hobson
# Date: 11/16/2010
# Description: 	Starts the failover daemon that manages failover splits
#
...
COMMAND="$PHP_BIN $DOCROOT_DIR/daemon.php -m Daemon -a Daemon --type=Failover --method=$1"
