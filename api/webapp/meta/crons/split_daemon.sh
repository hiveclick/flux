#!/bin/sh
#
# Starts the split daemon that manages splits
# Author: Mark Hobson
# Date: 11/16/2010
# Description: 	Starts the split daemon that manages splits
#
...
COMMAND="$PHP_BIN $DOCROOT_DIR/daemon.php -m Daemon -a Daemon --type=Split --method=$1"
