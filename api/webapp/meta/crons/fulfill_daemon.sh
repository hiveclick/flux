#!/bin/sh
#
# Starts the fulfillment daemon that manages fulfillments
# Author: Mark Hobson
# Date: 11/16/2010
# Description: 	Starts the fulfillment daemon that manages fulfillments
#
...
COMMAND="$PHP_BIN $DOCROOT_DIR/daemon.php -m Daemon -a Daemon --type=Fulfill --method=$1"
