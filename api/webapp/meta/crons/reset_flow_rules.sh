#!/bin/sh
#
# Resets the flow rule counters every night
# Author: Mark Hobson
# Date: 11/16/2010
# Description: 	Resets the flow rule counters every night
#
...
COMMAND="$PHP_BIN $DOCROOT_DIR/daemon.php -m Cron -a ResetFlowRules"
