...
<html lang="en">
    <head>
        ...
        <!-- Blueimp File upload utility -->
        <link href="/scripts/blueimp/css/jquery.fileupload.css" rel="stylesheet" type="text/css" />
        <script src="http://blueimp.github.io/JavaScript-Load-Image/js/load-image.min.js"></script>
        <script src="http://blueimp.github.io/JavaScript-Canvas-to-Blob/js/canvas-to-blob.min.js"></script>
        <script src="/scripts/blueimp/js/jquery.iframe-transport.js" type="text/javascript" ></script>
        <script src="/scripts/blueimp/js/jquery.fileupload.js" type="text/javascript" ></script>
        <script src="/scripts/blueimp/js/jquery.fileupload-process.js"></script>
        <script src="/scripts/blueimp/js/jquery.fileupload-image.js"></script>
        <script src="/scripts/blueimp/js/jquery.fileupload-audio.js"></script>
        <script src="/scripts/blueimp/js/jquery.fileupload-video.js"></script>
        <script src="/scripts/blueimp/js/jquery.fileupload-validate.js"></script>
                      ...
                      <div class="column col-sm-2 col-xs-1 sidebar-offcanvas" id="sidebar">
                          <div>
                            ...
                            <ul class="nav hidden-xs" id="lg-menu">
                                ...
                                <li class="<?php echo in_array($_SERVER['SCRIPT_NAME'], array('/flow/flow-search', '/flow/flow', '/flow/flow-wizard')) ? " active":"" ;?>"><a href="/flow/flow-search"><i class="glyphicon glyphicon-indent-left"></i> Flows</a></li>
                            ...
                            <ul class="nav visible-xs" id="xs-menu">
                                ...
                                <li class="<?php echo in_array($_SERVER['SCRIPT_NAME'], array('/flow/flow-search', '/flow/flow', '/flow/flow-wizard')) ? " active":"" ;?>"><a href="/flow/flow-search" class="text-center"><i class="glyphicon glyphicon-indent-left"></i></a></li>
