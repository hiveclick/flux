...
class ReportClient extends Base\ReportClient {
    ...
    public static function ensureIndexes() {
        ...
        $report_client->getCollection()->ensureIndex(array('client.client_id' => 1, 'report_date' => 1), array('unique' => true, 'background' => true));
        return true;
    }
