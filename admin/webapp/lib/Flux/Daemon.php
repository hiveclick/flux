...
class Daemon extends MongoForm {
	...
	public static function retrieveStatuses() {
		return array(
			self::DAEMON_STATUS_ACTIVE => 'Active',
			self::DAEMON_STATUS_INACTIVE => 'Inactive'
		);
	}
	
	/**
	 * Returns a list of run statuses
	 * @return multitype:string
	 */
	public static function retrieveRunStatuses() {
		return array(
			self::DAEMON_RUN_STATUS_ACTIVE => 'Running',
			self::DAEMON_RUN_STATUS_INACTIVE => 'Not Running'
		);
	}
