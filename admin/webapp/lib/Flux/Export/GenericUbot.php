...
class GenericUbot extends Generic {
	...
	function __construct() {
		$this->setFulfillmentType(parent::FULFILLMENT_TYPE_UBOT);
		$this->setName('UBot Fulfilled Lead');
		$this->setDescription('Leads that are fulfilled offline using a uBot script and just need to be flagged as fulfilled.');
	}
