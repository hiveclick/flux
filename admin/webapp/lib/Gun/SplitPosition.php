...
class SplitPosition extends MongoForm {
	...
	function sendLead($lead) {
		/*
		if ($this->getClientExport()->getExportType() == \Gun\ClientExport::CLIENT_EXPORT_TYPE_REALTIME) {
		...
		*/
			...
			/* @var $export_queue \Gun\SplitQueue */
			$export_queue = new \Gun\ExportQueue($export->getId());
