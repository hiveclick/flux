...
class Offer extends MongoForm {
	...
	const REDIRECT_TYPE_OFFER = 1;
	const REDIRECT_TYPE_FLOW = 2;
	const REDIRECT_TYPE_NONE = 3;
	...
	function getRedirectType() {
		if (is_null($this->redirect_type)) {
			$this->redirect_type = self::REDIRECT_TYPE_OFFER;
		}
	...
	public static function retrieveRedirectTypes() {
		return array(
				self::REDIRECT_TYPE_OFFER => 'Offer',
				self::REDIRECT_TYPE_FLOW => 'Flow',
				self::REDIRECT_TYPE_NONE => 'None'
		);
	}
