...
<div id="header">
    ...
    <h2><a href="/client/client-search">Clients</a> <small><a href="/client/client?_id=<?php echo $client_export->getClientId() ?>"><?php echo $client_export->getClient()->getName() ?></a> - <?php echo $client_export->getName() ?></small></h2>
</div>
<div id="tabs" class="navbar-collapse collapse">
    <ul id="export_tabs" class="nav nav-pills">
        ...
        <li><a id="tabs-a-map" href="#tabs-map" data-toggle="tab" data-url="/client/client-export-pane-map?_id=<?php echo $client_export->getId() ?>">Map</a></li>
        <li><a id="tabs-a-scheduling" href="#tabs-scheduling" data-toggle="tab" data-url="/client/client-export-pane-scheduling?_id=<?php echo $client_export->getId() ?>">Scheduling</a></li>
        <li><a id="tabs-a-export" href="#tabs-export" data-toggle="tab" data-url="/client/client-export-pane-export?_id=<?php echo $client_export->getId() ?>">Exports</a></li>
        <li><a id="tabs-a-spy" href="#tabs-spy" data-toggle="tab" data-url="/client/client-export-pane-spy?_id=<?php echo $client_export->getId() ?>">Spy</a></li>
    </ul>
</div>
