...
<form class="form-horizontal" name="offer_form" method="POST" action="" autocomplete="off">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<select class="form-control selectize" name="client_id" id="client_id" placeholder="Advertising Client">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<select class="form-control selectize" name="default_campaign_id" id="default_campaign_id" placeholder="Default Campaign">
