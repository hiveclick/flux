		...
		<form id="offer_search_form" method="GET" class="form-inline" action="/api">
			...
			<div class="text-right">
			    <div class="form-group text-left">
					<select class="form-control selectize" name="vertical_id_array[]" id="vertical_id_array" multiple placeholder="Filter by vertical">
...
$(document).ready(function() {
	var columns = [
		...
		{id:'landing_pages', name:'Preview', field:'landing_pages', sort_field:'traffic_source.name', def_value: ' ', maxWidth:64, width:64, minWidth:64, cssClass: 'text-center', type: 'string', formatter: function(row, cell, value, columnDef, dataContext) {
		    var ret_val = '';
		...
		{id:'vertical', name:'vertical', field:'vertical.vertical_name', def_value: ' ', sortable:true, cssClass: 'text-center', type: 'string', formatter: function(row, cell, value, columnDef, dataContext) {
