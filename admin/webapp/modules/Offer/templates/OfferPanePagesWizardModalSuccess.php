...
<form class="form-horizontal" id="offer_page_wizard_form" name="offer_page_wizard_form" method="POST" action="/api" autocomplete="off">
	...
	<div class="modal-body">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" id="file_path" name="file_path" class="form-control" placeholder="Enter file page (<?php echo $offer_page->getOffer()->getDocrootDir() ?>)" value="<?php echo $offer_page->getFilePath() ?>" />
			</div>
		</div>
		<p />
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" id="preview_url" name="preview_url" class="form-control" placeholder="Enter preview url (<?php echo $offer_page->getOffer()->getDomainName() ?>)" value="<?php echo $offer_page->getPreviewUrl() ?>" />
			</div>
		</div>
		<p />
	</div>
