    ...
    <div id="tabs-main" class="tab-pane active">
        ...
        <form name="main_form" method="POST" class="form-horizontal" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" id="name" name="name" class="form-control" required placeholder="Name" value="<?php echo $flow->getName() ?>" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" id="request_name" name="request_name" class="form-control" required placeholder="Request Name" value="<?php echo $flow->getRequestName() ?>" />
                </div>
            </div>
