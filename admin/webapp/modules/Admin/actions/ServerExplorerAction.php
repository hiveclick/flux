...
*/
class ServerExplorerAction extends BasicAction {
	...
	public function execute ()
	{
		...
		$server->query();
		$server->setFolderName($input_form->getFolderName());
		$server->setHtmlInputElementId($input_form->getHtmlInputElementId());
