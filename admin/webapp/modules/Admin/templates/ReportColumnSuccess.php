   ...
   <div id="tabs-main" class="tab-pane active">
		...
		<form class="form-horizontal" name="report_column_form" method="POST" action="" autocomplete="off" role="form">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" id="name" name="name" class="form-control" placeholder="Name" value="<?php echo $report_column->retrieveValue('name'); ?>" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<select class="form-control" name="column_type" id="column_type" placeholder="Type">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<select class="form-control" name="format_type" id="format_type" placeholder="Format Type">
			...
			<div id="parameters_<?php echo \Flux\ReportColumn::REPORT_COLUMN_TYPE_GROUP_DATAFIELD ?>" class="<?php echo $report_column->getColumnType() == \Flux\ReportColumn::REPORT_COLUMN_TYPE_GROUP_DATAFIELD ? "" : "hidden" ?>">
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select class="form-control" name="sum_type" id="sum_type" placeholder="Sum Type">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select class="form-control selectize" multiple name="parameters[]" id="parameter_datafield" placeholder="Data Fields">
			...
			<div id="parameters_<?php echo \Flux\ReportColumn::REPORT_COLUMN_TYPE_CALCULATION ?>" class="<?php echo $report_column->getColumnType() == \Flux\ReportColumn::REPORT_COLUMN_TYPE_CALCULATION ? "" : "hidden" ?>">
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select class="form-control" name="operator_type" id="operator_type" placeholder="Operator Type">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select class="form-control selectize" multiple name="parameters[]" id="parameter_report_column" placeholder="Report Columns">
