...
// +----------------------------------------------------------------------------+
class LeadSplitReturnedTodaySearchAction extends BasicAction
{
	...
	public function execute ()
	{
		...
		$lead_split->setDateRange(\Mojavi\Form\DateRangeForm::DATE_RANGE_LAST_7_DAYS);
		if (empty($lead_split->getDispositionArray())) {
			$lead_split->setDispositionArray(array(\Flux\LeadSplit::DISPOSITION_RETURNED));
		}
