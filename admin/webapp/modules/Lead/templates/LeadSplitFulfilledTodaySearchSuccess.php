...
<ol class="breadcrumb">
	...
	<li class="active">Fulfilled Leads for Today</li>
</ol>

<div class="container-fluid">
	<div class="page-header">
	   <h1>Fulfilled Leads for Today</h1>
	</div>
	<div class="help-block">These leads have been sent for fulfillment today and were accepted by the buyer.</div>
	<p />
...
function changeDisposition(obj) {
	$.rad.put('/lead/lead-split', { disposition: obj.disposition, _id: obj._id}, function(data) {
		$('#split_search_form').trigger('submit');
	});
}
//-->
