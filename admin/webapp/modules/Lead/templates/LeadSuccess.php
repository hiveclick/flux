	...
	<div class="pull-right">
		<div class="visible-sm visible-xs">
			<div class="btn-group">
				...
				<ul class="dropdown-menu dropdown-menu-right" role="menu">
					<li><a href="/lead/lead-page-search?_id=<?php echo $lead->getId() ?>">pages</a></li>
					<li><a data-toggle="modal" data-target="#note_modal" href="/lead/lead-pane-notes?_id=<?php echo $lead->getId() ?>">view notes</a></li>
		...
		<div class="hidden-sm hidden-xs">
			<div class="btn-group" role="group">
				<a class="btn btn-info" href="/lead/lead-page-search?_id=<?php echo $lead->getId() ?>">pages</a>
				<a class="btn btn-info" data-toggle="modal" data-target="#note_modal" href="/lead/lead-pane-notes?_id=<?php echo $lead->getId() ?>">view notes</a>
				<a class="btn btn-info" data-toggle="modal" data-target="#debug_modal" href="/lead/lead-pane-debug?_id=<?php echo $lead->getId() ?>">view debug</a>
			</div>
			<div class="btn-group" role="group">
...
<div class="col-md-4">
	<div class="panel panel-default">
		...
		<div class="panel-body word-break">
			...
			<dl class="dl-horizontal">
				<dt>Offer:</dt>
				<dd><a href="/offer/offer?_id=<?php echo $lead->getTracking()->getOffer()->getOfferId() ?>"><?php echo $lead->getTracking()->getOffer()->getOfferName() ?></a></dd>
				<dt>Client:</dt>
