	        	...
	        	<div class="panel-body">
	        	  <dl class="dl-horizontal">
	        	    ...
	        	    <?php if ($lead->getValue('ln') != '') { ?>
	        	          <dt>Lastname:</dt><dd><?php echo $lead->getValue('ln') ?>&nbsp;</dd>
	        	    <?php } ?>
	        	    <?php if ($lead->getValue('em') != '') { ?>
	        	          <dt>Email:</dt><dd><?php echo $lead->getValue('em') ?>&nbsp;</dd>
	        	    <?php } ?>
	        	    <?php if ($lead->getValue('a1') != '') { ?>
	        	          <dt>Address:</dt><dd><?php echo $lead->getValue('a1') ?>&nbsp;</dd>
	        	    <?php } ?>
	        	    ...
	        	    <?php if ($lead->getValue('zi') != '') { ?>
	        	          <dt>Zip:</dt><dd><?php echo $lead->getValue('zi') ?>&nbsp;</dd>
	        	    <?php } ?>
        	    </dl>
        	    <hr />
        	    <dl class="dl-horizontal">
                    ...
                    ?>
                        <?php if (!in_array($key, $known_fields)) { ?>
    	        		    <?php     	        		         
    	        		         $data_field = \Gun\DataField::retrieveDataFieldFromKeyName($key); 
    	        		         if (!is_null($data_field)) {
    	        		    ?>
        	        			<?php if ($data_field->getFieldType() == \Gun\DataField::DATA_FIELD_TYPE_BIRTHDATE) { ?>
        	        			...
        	        			<?php } else if ($data_field->getFieldType() == \Gun\DataField::DATA_FIELD_TYPE_DATETIME) { ?>
        	        			...
        	        			<?php } else if ($data_field->getFieldType() == \Gun\DataField::DATA_FIELD_TYPE_ARRAY) { ?>
        	...
        	<div class="panel panel-default">
	        	...
	        	<div class="panel-body word-break">
        		    ...
        		    <?php foreach ($lead->getT() as $key => $value) { ?>
	        		    <?php if (!in_array($key, array(\Gun\DataField::DATA_FIELD_REF_CLIENT_ID, \Gun\DataField::DATA_FIELD_REF_OFFER_ID))) { ?>
	        		        <?php 
	        		             $data_field = \Gun\DataField::retrieveDataFieldFromKeyName($key); 
	        		             if (!is_null($data_field)) {
	        		        ?>     
