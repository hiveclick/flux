...
<?php if ($split_position->getId() > 0) { ?>
    ...
    <form id="split_position_form_<?php echo $split_position->getId() ?>_<?php echo $split_position->getPosition() ?>" method="PUT" action="/api">
        ...
        <div class="modal-body">
            ...
            <div class="help-block col-md-12">
                Select any additional filters to use with this feed
            </div>

            <div class="form-group row">
                <label class="col-md-2 control-label" for="domain_group_id">Domains</label>
                <div class="col-md-10">
                    <select class="form-control" name="domain_group_id[]" id="domain_group_id_modal_<?php echo $split_position->getId() ?>_<?php echo $split_position->getPosition() ?>" placeholder="all domains" required multiple>
                        <?php foreach($domain_groups AS $domain_group) { ?>
                            <option value="<?php echo $domain_group->getId(); ?>" <?php echo in_array($domain_group->getId(), $split_position->getDomainGroupId()) ? "selected='selected'" : "" ?>><?php echo $domain_group->getName() ?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="col-md-2 control-label" for="data_field_id">Required fields</label>
                <div class="col-md-10">
                    <select class="form-control" name="data_field_id[]" id="data_field_id_modal_<?php echo $split_position->getId() ?>_<?php echo $split_position->getPosition() ?>" placeholder="no filters" required multiple>
                        <?php foreach($data_fields AS $data_field) { ?>
                            <option value="<?php echo $data_field->getId(); ?>" <?php echo in_array($data_field->getId(), $split_position->getDataFieldId()) ? "selected='selected'" : "" ?>><?php echo $data_field->getName() ?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>
