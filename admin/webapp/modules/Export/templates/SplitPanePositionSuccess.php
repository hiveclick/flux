...
<div class="pull-right hidden-xs">
    <a href="/export/split-pane-position-wizard?split_id=<?php echo $split->getId() ?>&position=1" data-toggle="modal" data-target="#split_position_modal"><span class="glyphicon glyphicon-plus"></span> Add New Feed</a>
</div>
<div class="visible-xs">
    <a href="/export/split-pane-position-wizard?split_id=<?php echo $split->getId() ?>&position=1" class="btn btn-warning form-control" data-toggle="modal" data-target="#split_position_modal"><span class="glyphicon glyphicon-plus"></span> Add New Feed</a>
</div>
