(function($) {
    function SlickGridPager(dataView, grid, $container)
    {
        ...
        function constructPagerUI()
        {
            ...
            var icon_prefix = "<button href='#' class='btn btn-sm btn-default'><span class='fa ";
            var icon_suffix = "'></span></button>";
            //var icon_prefix = "<span class='ui-state-default ui-corner-all ui-icon-container'><span class='ui-icon ";
            //var icon_suffix = "' /></span>";

            $(icon_prefix + "fa-list-alt" + icon_suffix)
...
*/
        ...
        function updatePager(pagingInfo)
        {
            ...
            if (!state.canGotoFirst) $container.find(".fa-step-backward").parent().attr("disabled", "disabled");
            if (!state.canGotoLast) $container.find(".fa-step-forward").parent().attr("disabled", "disabled");
            if (!state.canGotoNext) $container.find(".fa-forward").parent().attr("disabled", "disabled");
            if (!state.canGotoPrev) $container.find(".fa-backward").parent().attr("disabled", "disabled");
