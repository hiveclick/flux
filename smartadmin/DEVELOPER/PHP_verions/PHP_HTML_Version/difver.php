			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
					...
					<div class="jumbotron padding-10 text-center bg-color-white">
						...
						<h5 class="text-left padding-5" style="min-height:350px">				
							...
							Its built to run smoothly in all devices. Not highly recommended for large scoped projects as it can hog memory if you 
							do not manage your scripts properly. 
							<br>
							<br>
						...
						<a href="http://192.241.236.31/themes/preview/smartadmin/1.4/ajaxversion" target="_blank" class="btn btn-default btn-lg btn-block btn-primary">AJAX Demo <i class="fa fa-long-arrow-right"></i></a>
					</div>
				...
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
					...
					<div class="jumbotron padding-10 text-center bg-color-white">
						...
						<h5 class="text-left padding-5" style="min-height:350px">
							...
							It still uses lazyload method to load scripts, custom directives for navigation, message Board 
						...
						<a href="http://192.241.236.31/themes/preview/smartadmin/1.4/angularjs" target="_blank" class="btn btn-default btn-lg btn-block btn-danger">Angular Demo <i class="fa fa-long-arrow-right"></i></a>
					</div>
				...
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
					...
					<div class="jumbotron padding-10 text-center bg-color-white">
						...
						<a href="http://myorange.ca/themes/preview/smartadmin/1.4/phpversion/" target="_blank" class="btn btn-default btn-lg btn-block btn-primary">PHP Demo <i class="fa fa-long-arrow-right"></i></a>
					</div>
